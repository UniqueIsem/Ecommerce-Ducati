    ...
    <div className='carousel-container'>
      ...
      <Carousel responsive={responsive}>
        <div className='carousel-moto-card'>
          <NavLink to={'shopItem'} className='carousel-link'>
        ...
        <div className='carousel-moto-card'>
          <a className='carousel-link' href=''>
            <img className='carousel-moto-img' id='panigale' src='https://images.ctfassets.net/x7j9qwvpvr5s/4FTWbTAuoWs8QVIy54KHU2/291c35a9257e32d5d6f5b96475a8c74f/MTS-V4-PP-MY22-Model-Preview-1050x650-v06.png'></img>
        ...
        <div className='carousel-moto-card'>
          <a className='carousel-link' href=''>
            <img className='carousel-moto-img' id='panigale' src='https://images.ctfassets.net/x7j9qwvpvr5s/1dL0ilx4g9eUV1NHfvLeHE/ca7707e59bab41e8a6181ce9f9a84aaf/SPIN_DIAVEL_V4_RED.01.png?w=1920&fm=webp&q=95'></img>
        ...
        <div className='carousel-card'>
          <a className='carousel-link' href=''>
            <img className='carousel-moto-img' id='panigale' src='https://images.ctfassets.net/x7j9qwvpvr5s/50ROz2HdOdYEKElMawlOLN/c75b0e2913143608033fb2360890f2d8/XDiavel-Nera-SM-MY22-Model-Preview-1050x650.png'></img>
        ...
        <div className='carousel-card'>
          <a className='carousel-link' href=''>
            <img className='carousel-moto-img' id='panigale' src='https://images.ctfassets.net/x7j9qwvpvr5s/6PGHHlIyqxjiseChYKbodB/e5891a2b38879c3889646f2b57522a8e/DesertX-Rally-MY23-Model-Preview-1050x650.png'></img>
        ...
        <div className='carousel-card'>
          <a className='carousel-link' href=''>
            <img className='carousel-moto-img' id='panigale' src='https://images.ctfassets.net/x7j9qwvpvr5s/2TAgoHqGfb3JPR3zc28vur/a6968821b4a91dc948181f154b83aa8f/SF-V2-MY22-Model-Preview-1050x650-v06.png'></img>
        ...
        <div className='carousel-card'>
          <a className='carousel-link' href=''>
            <img className='carousel-moto-img' id='panigale' src='https://images.ctfassets.net/x7j9qwvpvr5s/2fq6l551352ZeWxgCqIqEY/519209694da4e416e9a3e99784ebc7f3/Hypermotard-698-Mono-RVE-360_00.png?w=1920&fm=webp&q=95'></img>
